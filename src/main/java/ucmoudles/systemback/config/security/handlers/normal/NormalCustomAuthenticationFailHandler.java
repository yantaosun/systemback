...
@Component
public class NormalCustomAuthenticationFailHandler implements AuthenticationFailureHandler {

    public static final String RETURN_TYPE = "json"; // 登录成功时，用来判断是返回json数据还是跳转html页面

    private Logger logger = LoggerFactory.getLogger(NormalCustomAuthenticationFailHandler.class);
